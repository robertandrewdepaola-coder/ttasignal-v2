# ADD THIS FUNCTION after _run_factual_brief() and before render_scanner_table()
...
# In your main content flow (around line 2800), add this after render_sidebar():

def main():
    render_sidebar()
    
    # === MARKET STRUCTURE DASHBOARD (standalone section) ===
    render_market_structure_section()  # ← ADD THIS LINE
